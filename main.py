...
if __name__ == "__main__":
    ...
    parser.add_argument("--policy", default="TD3", help='policy to use')
    ...
    parser.add_argument("--steps", default=3e5, type=int, help='Maximum number of steps')
